...
class BusinessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post businesses_url, params: { business: { b_name: @business.b_name, description: @business.description } }
    end
  ...
  test "should update business" do
    patch business_url(@business), params: { business: { b_name: @business.b_name, description: @business.description } }
